...
Solution is written in golang. To run the program, run the following command:
```
go run main.go <N>
```

where N is the number of aliens you want to create in the world.

Also to update the city map, update the file `city_map.txt` in the root directory.
